...
export default function BudgetStep({ value, onNext, onBack, step }: BudgetStepProps) {
  const [selected, setSelected] = useState(value)

  return (
    <div className="space-y-8">
      <BudgetSlider value={selected} onChange={setSelected} />
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <Button
          onClick={() => onNext("budget", selected)}
