...
export default function AllergiesStep({ value, onNext, onBack }: AllergiesStepProps) {
  const [selected, setSelected] = useState(value)

  return (
    <div className="space-y-8">
      <AllergiesInput value={selected} onChange={setSelected} />
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <Button
          onClick={() => onNext("allergies", selected)}
